            ...
            <form action="{{ route('dashboard.products.update' ,$product->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ old('description' , $product->description) }}" name="description" class="form-control" id="description"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="0.1" value="{{ old('price' ,$product->price) }}" name="price" class="form-control" id="price"
                    ...
                    <div class="form-group">
                        ...
                        <img src="{{ asset('storage/' . $product->image) }}" class="mt-3" width="120" height="120"  alt="">
                    </div>
                    <div class="form-group">
                        <label for="quantity">Quantity</label>
                        <input type="number" value="{{ old('quantity' , $product->quantity) }}" name="quantity" class="form-control" id="quantity"
